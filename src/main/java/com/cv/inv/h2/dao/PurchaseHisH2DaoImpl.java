 ...
 */
@Repository
public class PurchaseHisH2DaoImpl extends AbstractDao<String, PurHisH2> implements PurchaseHisH2Dao {
    ...
    public List<PurHisH2> search(String fromDate, String toDate, String cusId, String vouStatusId, String remark) {
        ...
        List<PurHisH2> listPurHis = findHSQL(strSql);
        return listPurHis;
    }

    @Override
    public PurHisH2 findById(String id) {
        PurHisH2 ph = getByKey(id);
        return ph;
    }
