 ...
 */
@Entity
@Table(name = "chart_of_account_h2")
public class ChartOfAccountH2 implements java.io.Serializable {
    ...
    public ChartOfAccountH2() {
    }

    public ChartOfAccountH2(String code, String coaNameEng) {
        this.code = code;
