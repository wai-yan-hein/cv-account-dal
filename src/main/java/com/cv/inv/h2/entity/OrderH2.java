 ...
 */
@Entity
@Table(name = "order_his_h2")
public class OrderH2 implements Serializable {
    ...
    public TraderH2 getTrader() {
        return trader;
    }

    public void setTrader(TraderH2 trader) {
        this.trader = trader;
    }
