 ...
 */
@Entity
@Table(name = "pur_his_h2")
public class PurHisH2 implements java.io.Serializable {

    private String purInvId;
    private TraderH2 customerId;
    private Date purDate;
    private Date dueDate;
    private PaymentTypeH2 paymentTypeId;
    ...
    public TraderH2 getCustomerId() {
        return customerId;
    }

    public void setCustomerId(TraderH2 customerId) {
    ...
    public PaymentTypeH2 getPaymentTypeId() {
        return paymentTypeId;
    }

    public void setPaymentTypeId(PaymentTypeH2 paymentTypeId) {
    ...
    public VouStatusH2 getVouStatus() {
        return vouStatus;
    }

    public void setVouStatus(VouStatusH2 vouStatus) {
    ...
    public DepartmentH2 getDeptCode() {
        return deptCode;
    }

    public void setDeptCode(DepartmentH2 deptCode) {
