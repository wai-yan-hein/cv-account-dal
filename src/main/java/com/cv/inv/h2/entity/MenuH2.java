...
@Entity
@Table(name = "menu_h2")
public class MenuH2 implements java.io.Serializable {
    ...
    private List<MenuH2> child;

    public MenuH2() {

    }

    public MenuH2(Integer id, String menuName, String menuType) {
        this.id = id;
    ...
    @Transient
    public List<MenuH2> getChild() {
        return child;
    }

    public void setChild(List<MenuH2> child) {
        this.child = child;
    }
