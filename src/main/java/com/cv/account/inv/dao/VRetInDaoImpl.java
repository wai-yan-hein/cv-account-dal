...
import com.cv.account.inv.entity.view.VRetIn;
 ...
 */
@Repository
public class VRetInDaoImpl extends AbstractDao<String, VRetIn> implements VRetInDao {
    ...
    public List<VRetIn> search(String fDate, String tDate, String cusId, String locId, String vouNo, String stockCodes, String compCode) {
        String strSql = "select distinct o from VRetIn o";
        String strFilter = "";
