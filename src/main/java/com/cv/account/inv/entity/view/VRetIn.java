 ...
 */
package com.cv.account.inv.entity.view;
...
@Entity
@Table(name = "v_ret_in")
public class VRetIn implements Serializable {

    @EmbeddedId
    private RetInCompoundKey key;
    ...
    public RetInCompoundKey getKey() {
        return key;
    }

    public void setKey(RetInCompoundKey key) {
        this.key = key;
    }
