...
import com.cv.account.api.entity.AppUser;
import com.cv.account.api.entity.ChartOfAccount;
import com.cv.account.api.entity.Currency;
import com.cv.account.api.entity.DateModel;
...
import com.cv.account.inv.entity.CharacterNo;
import com.cv.account.inv.entity.ChargeType;
import com.cv.account.inv.entity.Location;
import com.cv.account.inv.entity.MachineInfo;
import com.cv.account.inv.entity.RelationKey;
import com.cv.account.inv.entity.SaleMan;
import com.cv.account.inv.entity.Stock;
import com.cv.account.inv.entity.StockBrand;
import com.cv.account.inv.entity.StockType;
import com.cv.account.inv.entity.StockUnit;
