...
package com.cv.account.api.entity.view;
 ...
 */
@Entity
@Table(name="v_coa_dept_map")
public class VCOADeptMap implements java.io.Serializable{
    private String code;
    ...
    @Column(name="dept_coa_code")
    public String getDeptCoaCode() {
        return deptCoaCode;
    }

    public void setDeptCoaCode(String deptCoaCode) {
        this.deptCoaCode = deptCoaCode;
    }

    @Column(name="dept_map")
    public String getDeptMap() {
        return deptMap;
    }

    public void setDeptMap(String deptMap) {
